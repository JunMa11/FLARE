...
if __name__ == '__main__':
    ...
    parser.add_argument("-docker_name", default='fully_suplearn_subtask1', help="docker output folder") 
    ...
    p1.start()
    t0 = time.time()
    cmd = 'nvidia-docker run --name {} --rm -v $PWD/inputs/:/workspace/input/ -v $PWD/outputs/:/workspace/outputs/ {}:latest /bin/bash -c "sh {}"'.format(
